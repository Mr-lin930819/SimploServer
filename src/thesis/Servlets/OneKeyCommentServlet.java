 ...
 */
@WebServlet(description = "一键教学评价", urlPatterns = { "/OneKeyCommentServlet" })
...
//				request.getParameter("cookie")).doQuery();
	...
	class DoComment extends InfoQueryTemplate{
		...
		protected void setSpecialParams(HashMap<String, String> params) {
			...
			params.put("DataGrid1:_ctl2:JS1", "非常符合");
			params.put("DataGrid1:_ctl3:JS1", "非常符合");
			params.put("DataGrid1:_ctl4:JS1", "非常符合");
			params.put("DataGrid1:_ctl5:JS1", "非常符合");
			params.put("DataGrid1:_ctl6:JS1", "非常符合");
			params.put("DataGrid1:_ctl7:JS1", "非常符合");
			params.put("DataGrid1:_ctl8:JS1", "非常符合");
			params.put("DataGrid1:_ctl9:JS1", "非常符合");
			params.put("DataGrid1:_ctl10:JS1", "非常符合");
			params.put("DataGrid1:_ctl11:JS1", "非常符合");
		}
